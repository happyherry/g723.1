...
extern Word16 mac_r(Word32 L_var3, Word16 var1, Word16 var2);/* Mac with rounding,*/
extern Word16 msu_r(Word32 L_var3, Word16 var1, Word16 var2);/* Msu with rounding,*/
